...
dbLoadRecords("db/MDigRegisters.template", "CRATE=01,BOARD=MDIG2")
dbLoadRecords("db/MDigRegisters.template", "CRATE=01,BOARD=MDIG3")
dbLoadRecords("db/MDigRegisters.template", "CRATE=01,BOARD=MDIG4")
taskDelay(100)

## Load Users Templates
dbLoadRecords("db/MDigUser.template", "CRATE=01,BOARD=MDIG1")
dbLoadRecords("db/MDigUser.template", "CRATE=01,BOARD=MDIG2")
dbLoadRecords("db/MDigUser.template", "CRATE=01,BOARD=MDIG3")
dbLoadRecords("db/MDigUser.template", "CRATE=01,BOARD=MDIG4")
taskDelay(100)
 
## Load daqSegment2.template for each digitizer in crate
dbLoadRecords("db/daqSegment2.template", "CRATE=01,BOARD=MDIG1")
dbLoadRecords("db/daqSegment2.template", "CRATE=01,BOARD=MDIG2")
dbLoadRecords("db/daqSegment2.template", "CRATE=01,BOARD=MDIG3")
dbLoadRecords("db/daqSegment2.template", "CRATE=01,BOARD=MDIG4")
taskDelay(100)
...
dbpf "VME01:MDIG1:user_package_data","101"
dbpf "VME01:MDIG2:user_package_data","102"
dbpf "VME01:MDIG3:user_package_data","103"
dbpf "VME01:MDIG4:user_package_data","104"

seq &inLoop,"CRATE=01,B0=MDIG1,B1=MDIG2,B2=MDIG3,B3=MDIG4,B4=X,B5=X,B6=X"
taskDelay(100)
seq &outLoop,"CRATE=01"
taskDelay(100)
seq &MiniSender,"CRATE=01"
